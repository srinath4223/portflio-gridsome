    ...
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <!--Home-->
          <li>
            <a v-if="$route.path === '/'" href="/#"  class="text-copy-primary hover:text-gray-600" data-cypress="projects">Home</a>
          ...
          <!--
          <li>
            <a  href="https://www.notion.so/Resume-e8050f0b87f24bc5bacc116b7578a1ef"  class="text-copy-primary hover:text-gray-600" data-cypress="projects" target="_blank">resume</a>
          ...
          <!--Likedin-->
          <li>
            <a  href="https://www.linkedin.com/in/srinath-sirimalla-48b4b998/"  class="text-copy-primary hover:text-gray-600" data-cypress="projects" target="_blank">Linkedin</a>
          </li>


          <!--Githubs-->
          <li>
            <a  href="https://github.com/srinath4223/"  class="text-copy-primary hover:text-gray-600" data-cypress="projects" target="_blank">Github</a>
          </li>

           <!--twitter-->
          <li>
            <a  href="https://twitter.com/srinath4223"  class="text-copy-primary hover:text-gray-600" data-cypress="projects" target="_blank">twitter</a>
          </li>
