  ...
  <Layout>
    <div class="hero container-inner mx-auto flex flex-col sm:flex-row justify-between py-16">
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        <div class="leading-tight">Srinath Sirimalla</div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl"> Hi, I am a Software engineer from Hyderabad, India and am interested in data engineering, distributed systems and 
        cloud computing. </p>
    ...
    <div class="overflow-x-hidden">
      <div class="projects container-inner mx-auto text-xl border-t border-gray-500 border-b py-16 mb-16 relative">
        ...
        <ul class="text-lg sm:text-xl space-y-6">
          ...
          <li class="checkmark">
            <div>Fake Facts </div>
            <div class="text-lg text-gray-600">This gridsome theme was forked from my <a href="https://andremadarang.com">personal website</a>. I added more features and decided to release it as an open source project. Check it out on <a href="https://github.com/drehimself/gridsome-portfolio-starter">GitHub</a> or check out the <a href="https://www.youtube.com/watch?v=uHo6o1TNQeE">screencast I did</a>. 
           Feel free to use it for your own site or projects! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minima, repellat. Dolores iure, quas perspiciatis rerum quaerat atque eum repellat autem.</div>
          </li>
          -->
        ...
        <li class="checkmark">
            <div>Fake Fact hub</div>
            <div class="text-lg text-gray-600">Do you like websites like <a href = "https://www.theonion.com/" target = "_blank">The Onion.</a> I do too!. So, I tried to create a hub of fake facts where users can post fake facts and see posts by others. The application also has a cool bot which posts a random fact in the user's feed. Built using Flask, Pusher for web sockets, Postgres and Docker. Check out the <a href="https://github.com/srinath4223/Random-cube" target="_blank">code</a></div>
          </li>


          <li class="checkmark">
            <div>Random Cube</div>
            <div class="text-lg text-gray-600">A web application with Flask, Celery, Redis, PostgreSQL, Stripe and Docker.
            In this application users can buy coupons and bet them on the outcome of a random game like rolling a  cube. 
            Check out the <a href="https://github.com/srinath4223/fake-facts-hub" target="_blank">code</a></div>
          </li>



          <li class="checkmark">
            <div>Automatic Invoice Generation</div>
            <div class="text-lg text-gray-600">A web application built using flask and weasyprint which  if given invoice details as input will generate a PDF and send an email to the given recipients Check  out the  <a href="https://github.com/srinath4223/automatic-invoice-generator.git" target="_blank">code</a></div>
          </li>

          
          <li class="checkmark">
            <div>FIFA World Cup Twilio Bot</div>
            <div class="text-lg text-gray-600">It was FIFA World Cup season and everyone was rooting for their favorite team. So for this project, I created  a bot that can help people stay updated on how the FIFA World Cup is progressing. This project is a Twilio application, hosted on Heroku. It is a chat (SMS) bot of sorts. You will be able to send various special messages to this bot and it will respond with the  latest World Cup updates. Check  out the <a href="https://github.com/srinath4223/FIFA-twilio-bot" target="_blank">code</a></div>
          </li>

          
          <li class="checkmark">
            <div>Making a Reddit + Facebook Messenger Bot</div>
            <div class="text-lg text-gray-600">This project is a Facebook messenger bot which serves you fresh memes, motivational posts, jokes, and shower thoughts. This project uses flask framework, reddit as the data source and is deployed on heroku.Check  out the code on <a href="https://github.com/srinath4223/Facebook-messenger-bot" target="_blank">GitHub</a> </div>
          </li>

          <li class="checkmark">
            <div>Web Scraping using lxml</div>
            <div class="text-lg text-gray-600">This is  a script which will provide you access to
            data on Steam in an easy to use format for your own applications.Check  out the code on <a href="https://github.com/srinath4223/scraping-lxml-steam.git" target="_blank">GitHub</a></div>
          </li>
